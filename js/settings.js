...
<title>HBVS Settings v7.8.45</title>
...
.card {
  ...
  background: var(--card);
  border-radius: 12px;
  box-shadow: 0 2px 4px rgba(139,90,43,0.08);
}
.section-label {
  font-size: 12px;
  font-weight: 800;
...
<div id="app">
  <header id="topbar">
    <div class="topbar-row1">
      ...
      <div class="logo-title"><div class="app-title">HBVS SETTINGS</div></div>
    </div>
  </header>
  ...
  <main>
    <div class="card">
      ...
      <div class="section-label">EPILOGUE BOOK</div>
      ...
      <div class="setting-row">
        <label>Load Epilogue.txt</label>
        <input type="file" id="epilogue-file" accept=".txt">
      </div>

      <button class="btn-export" id="btn-export-epilogue">Export Epilogue.json</button>

    </div>
  </main>
</div>

<!-- [v7.8.65] SHARED LAYOUT - Bottom Bar -->
